#!/usr/bin/env python3
"""
Test Bright Data LinkedIn Filter API with 2 hospitals
Export results to Lucas_test.csv
"""
...
# Test with 2 hospitals from the CSV
TEST_HOSPITALS = [
    {
        "company_name": "St. Luke's Regional Medical Center",
        "city": "Boise",
        "state": "ID",
...
def main():
    print("=" * 80)
    print("Bright Data LinkedIn Filter - Lucas Test (2 Hospitals)")
    print("=" * 80)
    ...
    for i, hospital in enumerate(TEST_HOSPITALS, 1):
        print(f"\n[{i}/2] Testing: {hospital['company_name']} ({hospital['city']}, {hospital['state']})")
        print("-" * 80)
    ...
    if all_results:
        ...
        fieldnames = [
            "hospital_name", "hospital_city", "hospital_state", "account_id",
