#!/usr/bin/env python3
"""
MedStar Health Prospect Discovery Test - IMPROVED VERSION
...
def test_medstar_discovery():
    ...
    print("=" * 80)
    print("🏥 MEDSTAR HEALTH - IMPROVED PROSPECT DISCOVERY TEST")
    print("=" * 80)
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if data.get('status') == 'success':
                ...
                print(f"\n📋 FILTERED OUT PROSPECTS (examples):")
                print("-" * 80)
                filtered_details = funnel.get('detailed_filtered_prospects', [])
                for i, filtered in enumerate(filtered_details[:10], 1):  # Show first 10
                ...
                if prospects:
                    for i, prospect in enumerate(prospects, 1):
                        ...
                        print(f"   Scoring Reason: {ai_ranking.get('ranking_reasoning', 'N/A')}")
                else:
                ...
                filename = f"medstar_improved_{timestamp}.json"
