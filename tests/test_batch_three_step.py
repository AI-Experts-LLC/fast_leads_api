"""
Batch test script for 3-step prospect discovery API
...
# Batch configuration - SET THESE BEFORE RUNNING
START_ROW = 1  # 0-indexed (row 1 = first hospital after header)
END_ROW = 3    # Exclusive (so END_ROW=3 means process rows 1 and 2)
...
def main():
    ...
    print_section(f"3-STEP BATCH PROSPECT DISCOVERY")
    print(f"CSV File: {CSV_FILE}")
    print(f"Processing rows {START_ROW} to {END_ROW-1} (inclusive)")
